...
class Directivos_grupos_ver_estudiantes extends React.Component {
  ...
  componentWillMount() {
    ...
    axios
      .get(
        `http://35.185.93.150:4535/grupos-estudiantes/estudiantes-ver-grupos-estudiantes-directivos/${this.state.id_grupo}`
      )
      .then((res) => {
  ...
  componentDidMount() {
    ...
    axios
      .get(
        `http://35.185.93.150:4535/grupos-materias/directivos-materias-grupo/${this.state.id_grupo}`
      )
      .then((res) => {
        console.log(res.data);
        this.setState({
