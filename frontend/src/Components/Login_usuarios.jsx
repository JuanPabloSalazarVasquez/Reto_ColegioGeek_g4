...
class Login_usuarios extends React.Component {
  ...
  login = async () => {
    await axios
      .post(`http://35.185.93.150:4535/api/login`, {
  ...
  login2 = async () => {
    ...
    await axios
      .get(`http://35.185.93.150:4535/api/privada`, {
        headers: {
  ...
  Ingreso = async () => {
    await axios
      .get(
        `http://35.185.93.150:4535/api/user-datos/${this.state.datos_user.id_persona}/${this.state.datos_user.tipo_usuario}`
      )
      .then((res) => {
        console.log(
